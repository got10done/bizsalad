...
<body class="" style="width:100%; height:100%;">
	...
	<div id="biz-content-wrap">
	  ...
	  <div class="d-table w100pro biz-content-wrap-con">
		...
		<div class="d-table w100pro auto big-text" style="width:400px;">
			<div>
				<div class="big-text">주문번호: <input type=text class="input-h40r w100pro big-text3 ma-t-dot5" value="${vo.purchase_seq}" readonly /></div>
				<div class="big-text">작업지시번호: <input type=text class="input-h40r w100pro big-text3 ma-t-dot5" value="${vo.cart_seq}" readonly /></div>
				<div class="big-text">수량: <input type=text class="input-h40r w100pro big-text3 ma-t-dot5" value="${vo.quantity}" readonly /></div>
				<div class="big-text">단가: <input type=text class="input-h40r w100pro big-text3 ma-t-dot5" value="${vo.price}" readonly /></div>
				<div class="big-text"><input type=text class="input-h40r w100pro big-text3 ma-t-dot5" value="${vo.option_seq}" readonly /></div>
			</div>
			<div>
				<button id="btnOk" class="btn-h40r w30pro big-text letterdot5 pa-2em rrr template_bg1 ma-t-dot5 ma-r-dot5">승인</button>
				<button id="btnNo" class="btn-h40r w30pro big-text letterdot5 pa-2em rrr template_bg1 ma-t-dot5 ma-r-dot5">거부</button>
				<input type="button" class="btn-h40r w30pro big-text letterdot5 pa-2em rrr template_bg1 ma-t-dot5 ma-r-dot5" id="gong" value="공정관리"/>  
			</div>
